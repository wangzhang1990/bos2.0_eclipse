...
public class SmsUtils {
	private static String userid = "alpha_idea";
	private static String pass = "nihao123";
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(sendSmsByHTTP("17791873101", "尊敬的用户您好，本次获取的验证码为："
		 + randomCode + ",服务电话：4006184000"));
		//System.out.println(sendSmsByWebService("1", "尊敬的用户您好，本次获取的验证码为："
				 //+ randomCode + ",服务电话：4006184000"));
	}
}
